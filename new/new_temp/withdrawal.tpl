{$pageName = "Request for withdrawal"}
...
{else}
                  ...
                  <form method=post>
                      ...
                      <input type=hidden name=action value=preview>
                        ...
                        <table cellspacing="0" cellpadding="2" border="0" class="tab">
                            <tbody><tr>
                                ...
                                <th>{$currency_sign}<b>{$ab_formated.total}</b></th>
                            </tr>
                            <tr><td>&nbsp;</td>
                                <td> <small>
                    ...
                    {/section}
                            ...
                            <tr>
                                <td>{$ps.name|escape:html} Account:</td>
                                <td>
                                    {if $ps.account != ''}{$ps.account|escape:html}{else}<a href=?a=edit_account><i>not set</i></a>{/if}
                                </td>
                            </tr>
                            {/foreach}
                            {foreach item=p from=$mpay_accounts}
                            <tr>
                                <td>{$p.name|escape:html} Account:</td>
                                <td>
