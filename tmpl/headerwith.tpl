...
<div class="col-12" style="">
                        ...
                        <center style="padding: 20px;margin-bottom: 60px;/* text-align: left; */border-bottom: 2px solid #ececec;"> <font style="font-size: 20px;color: #00017a;    line-height: 30px;">Retirar ganancias</font></center>
